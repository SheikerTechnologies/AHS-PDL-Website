    ...
    <section className="w-full py-12 bg-surface select-none">
      <div className="w-full max-w-6xl mx-auto px-6 md:px-8">
        <motion.div
          ...
          className="bg-surface-alt rounded-[40px] border border-border-main/60 p-8 md:p-12 shadow-[0_15px_45px_rgba(0,0,0,0.04)] grid grid-cols-1 md:grid-cols-12 gap-10 items-center relative overflow-hidden"
        >
          ...
          <div className="md:col-span-7 flex flex-col text-left gap-5">
            ...
            <p className="text-sm text-text-secondary leading-relaxed font-normal max-w-md">
